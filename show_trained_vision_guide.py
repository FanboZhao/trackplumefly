from flybody.fly_envs import vision_guided_flight, flight_imitation
...
for _ in tqdm(range(200)):
    ...
    frames.append(env.physics.render(camera_id=6, width=640, height=480))

mediapy.write_video('video/bumps_task.mp4', frames, fps=30)
env.close()
