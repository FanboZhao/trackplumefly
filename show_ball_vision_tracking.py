...
low_level_ckpt_path = 'saved_checkpoints/ckpt-580'
...
mediapy.write_video('video/tracking_view01.mp4', frames1, fps=30)
mediapy.write_video('video/tracking_view02.mp4', frames2, fps=30)
env.close()
print("Finished!")