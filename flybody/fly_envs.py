...
from flybody.tasks.ball_vision_tracking_flight import BallVisionTrackingTask
from flybody.tasks.plume_tracking import PlumeTracking
...
def ball_vision_tracking_flight(wpg_pattern_path: str | None = None,
                         bumps_or_trench: str = 'bumps',
                         force_actuators: bool = False,
                         disable_legs: bool = True,
                         random_state: np.random.RandomState | None = None,
    ...
    # Build task.
    time_limit = 0.4
    task = BallVisionTrackingTask(walker=walker,
                                     arena=arena,
                                     wbpg=wbpg,
                                     time_limit=time_limit,
                                     force_actuators=force_actuators,
...
def plume_tracking(wpg_pattern_path: str | None = None,
                    bumps_or_trench: str = 'bumps',
                    force_actuators: bool = False,
                    disable_legs: bool = True,
                    random_state: np.random.RandomState | None = None,
    ...
    # Build task.
    time_limit = 0.4
    task = PlumeTracking(walker=walker,
                        arena=arena,
                        wbpg=wbpg,
                        time_limit=time_limit,
                        force_actuators=force_actuators,
