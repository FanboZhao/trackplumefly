...
class FruitFlyTask(composer.Task, ABC):
    ...
    def initialize_episode_mjcf(self, random_state: np.random.RandomState):
        ...
        self.root_entity.mjcf_model.visual.map.force = 0.00001 # 0.00002
        self.root_entity.mjcf_model.visual.scale.framewidth = 0.06 #0.01
        ...
        self.root_entity.mjcf_model.visual.scale.jointwidth = 0.06 # 0.01
